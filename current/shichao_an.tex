...
\ \ \href{http://shichao.io/}{\color{NavyBlue} shichao.io} \textbullet
...
\begin{itemize}
    ...
    \begin{narrowitems}
		...
		\sbullet Enabled automatic conversation feature that supports pattern-based and user-extended chat methods, and external chatterbot APIs such as SimSimi 
    \end{narrowitems}

    \item
    \headerrow
	{\bigtitle{\linktitle{https://github.com/shichao-an/GeoPort}{GeoPort}\shortdesc{Geo-Social Platform}}}
    ...
    \item
    \headerrow
	{\bigtitle{\linktitle{http://shichao.io/_static/ppp.pdf}{Python and Parallel Programming}\shortdesc{Multicore Processors Course Project}}}
...
\begin{itemize}
    ...
    \item
    \headerrow
    {\linktitle{http://www.fuhu.com/}{Fuhu}  \color{dgray} \small (San Jose, CA)}
    {\emph{\color{dgray} \small 08/2014 -- present}}
    \subtitle{Junior System Administrator}

    \begin{narrowitems}
        \sbullet Administer application servers, databases, storage and networking systems
		\sbullet Manage and maintain the cloud infrastructure (AWS) with configuration management tools
		\sbullet Implemented automation scripts for server management, deployment and monitoring
		\sbullet Establish team development, support and network services
    \end{narrowitems}
