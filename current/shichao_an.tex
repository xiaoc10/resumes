...
\begin{itemize}
    ...
    \headerrow
        { \small System Administrator and Programmer \color{dgray} (Department of Network)}

    \begin{itemize*} \small
        \item[-]\leftskip-1em \rightskip2.8cm Maintained the Linux server and managed MediaWiki sub-site, deploying retrofits, extensions and automated tasks (bot)
    \end{itemize*}
...
\begin{tabularx} 
{\textwidth}{l l l}
 \textbf{Languages:} & & \textbf{Web:} Django, WordPress, Node.js, jQuery \\
