...
\begin{tabularx} 
{\textwidth}{l l l}
\textbf{Programming Languages:} & & \textbf{Web Development:} HTML5, Django, jQuery, Bootstrap \\[0.3ex]
\hspace{1em}{\color{dgray} Proficient:} Python, C, Bash scripting & & \textbf{Databases:} MySQL, MongoDB, Oracle\\[0.3ex]
...
\end{tabularx}
\textbf{Software and Technologies:} Vim, Git, KVM, Puppet, Selenium, Amazon Web Services
\end{indentsection}
